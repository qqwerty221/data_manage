...
exports.ServiceTask = exports.ServiceTaskView = exports.ServiceTaskModel = void 0;
...
var ServiceTaskModel = /** @class */ (function (_super) {
    ...
    function ServiceTaskModel(data, graphModel) {
        if (!data.id) {
            data.id = "Activity_".concat((0, getBpmnId_1.getBpmnId)());
        }
...
exports.ServiceTaskModel = ServiceTaskModel;
...
exports.ServiceTaskView = ServiceTaskView;
exports.ServiceTask = {
    type: 'bpmn:serviceTask',
    view: ServiceTaskView,
    model: ServiceTaskModel,
};
exports.default = exports.ServiceTask;
