...
exports.EndEvent = exports.EndEventView = exports.EndEventModel = void 0;
...
var EndEventModel = /** @class */ (function (_super) {
    ...
    function EndEventModel(data, graphModel) {
        if (!data.id) {
            data.id = "Event_".concat((0, getBpmnId_1.getBpmnId)());
        }
        if (!data.text) {
            data.text = '';
        }
...
var EndEventView = /** @class */ (function (_super) {
    ...
    EndEventView.prototype.getShape = function () {
        ...
        return (0, core_1.h)('g', {}, outCircle, (0, core_1.h)('circle', __assign(__assign({}, style), { cx: x, cy: y, r: r - 5 })));
    };
...
exports.default = exports.EndEvent;
