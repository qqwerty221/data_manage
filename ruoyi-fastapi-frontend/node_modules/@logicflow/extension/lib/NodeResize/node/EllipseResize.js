...
exports.EllipseResize = exports.EllipseResizeView = exports.EllipseResizeModel = void 0;
...
exports.EllipseResizeModel = EllipseResizeModel;
var EllipseResizeView = /** @class */ (function (_super) {
    ...
    EllipseResizeView.prototype.getShape = function () {
        ...
        return ((0, jsx_runtime_1.jsxs)("g", { children: [this.getResizeShape(), model.isSelected && !isSilentMode ? this.getControlGroup() : ''] }));
    };
    return EllipseResizeView;
}(core_1.EllipseNode));
exports.EllipseResizeView = EllipseResizeView;
exports.EllipseResize = {
    type: 'ellipse',
    view: EllipseResizeView,
    model: EllipseResizeModel,
};
exports.default = exports.EllipseResize;
