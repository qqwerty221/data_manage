...
exports.GatewayNodeFactory = exports.gatewayComposable = exports.gateway = void 0;
...
function GatewayNodeFactory(type, icon, props) {
    var view = /** @class */ (function (_super) {
        ...
        view.prototype.getShape = function () {
            ...
            }, (0, core_1.h)(core_1.Polygon, __assign(__assign({}, style), { x: x, y: y, points: points })), typeof icon === 'string'
                ? (0, core_1.h)('path', __assign(__assign({ d: icon }, style), { fill: 'rgb(34, 36, 42)', strokeWidth: 1 }))
                : icon);
        };
        return view;
    }(core_1.PolygonNode));
    var model = /** @class */ (function (_super) {
        ...
        function model(data, graphModel) {
            var _this = this;
            if (!data.id) {
                data.id = "Gateway_".concat((0, utils_1.genBpmnId)());
            }
            if (!data.text) {
                data.text = '';
            }
