...
function IntermediateCatchEventFactory(lf) {
    ...
    var view = /** @class */ (function (_super) {
        ...
        view.prototype.getShape = function () {
            ...
            return (0, core_1.h)('g', {}, (0, core_1.h)('circle', __assign(__assign({}, style), { cx: x, cy: y, r: r, strokeWidth: 1.5 })), (0, core_1.h)('circle', __assign(__assign({}, style), { cx: x, cy: y, r: r - 3, strokeWidth: 1.5 })), i);
        };
        return view;
    }(core_1.CircleNode));
