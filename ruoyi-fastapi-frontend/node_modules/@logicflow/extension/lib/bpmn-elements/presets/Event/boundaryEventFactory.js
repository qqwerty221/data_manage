...
function BoundaryEventFactory(lf) {
    ...
    var view = /** @class */ (function (_super) {
        ...
        view.prototype.getShape = function () {
            ...
            var _b = model, x = _b.x, y = _b.y, r = _b.r, width = _b.width, height = _b.height, properties = _b.properties;
            ...
            var i = Array.isArray(icon)
                ? core_1.h.apply(void 0, __spreadArray(['g',
                    {
                        transform: "matrix(1 0 0 1 ".concat(x - width / 2, " ").concat(y - height / 2, ")"),
                    }], __read(icon), false)) : (0, core_1.h)('path', {
                transform: "matrix(1 0 0 1 ".concat(x - width / 2, " ").concat(y - height / 2, ")"),
                d: icon,
            });
            return (0, core_1.h)('g', {}, (0, core_1.h)('circle', __assign(__assign({}, style), { cx: x, cy: y, r: r, strokeDasharray: cancelActivity ? '' : '5,5', strokeWidth: 1.5 })), (0, core_1.h)('circle', __assign(__assign({}, style), { cx: x, cy: y, r: r - 3, strokeDasharray: cancelActivity ? '' : '5,5', strokeWidth: 1.5 })), i);
        };
        return view;
    }(core_1.CircleNode));
    var model = /** @class */ (function (_super) {
        ...
        function model(data, graphModel) {
            ...
            var _a, _b, _c;
            if (!data.id) {
                data.id = "Event_".concat((0, utils_1.genBpmnId)());
            }
            if (!data.text) {
                data.text = '';
            }
            ...
            ((_c = data.properties) === null || _c === void 0 ? void 0 : _c.definitionType) &&
                (data.properties.definitionId = "Definition_".concat((0, utils_1.genBpmnId)()));
